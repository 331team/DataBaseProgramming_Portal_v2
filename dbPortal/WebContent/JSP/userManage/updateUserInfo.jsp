...
<head>
	...
	<script type="text/javascript">
		function showPopup() { window.open("deleteUser.jsp", "회원탈퇴", "width=400, height=300, left=100, top=50"); }
	</script>
</head>
<body>
	...
	<form method="post" action="./updateUserVerify.jsp">
		<div class="form-group">
			<label for="inputEmail3">아이디</label>
			<input type="text" class="form-control" id="inputEmail" name="usrID" value="<%=session_id %>" disabled>
		</div>
		<div class="form-group">
		...
		<section class="container mt-3" style="max-width:560px;">
			<div class="row justify-content-between">
				...
				<div class="form-group"> 
					<button type="button" class="btn btn-danger" onClick="showPopup();">회원탈퇴</button>
				</div>	  
			</div>  
		</section>  
	</form>
